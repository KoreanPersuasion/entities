...
function ENT:Destruct()
	...
	GAMEMODE:Notify(self.dt.owning_ent, 1, 4, "Your diamond printer has exploded!")
end

function ENT:BurstIntoFlames()
	GAMEMODE:Notify(self.dt.owning_ent, 1, 4, "Your diamond printer is overheating!")
	self.burningup = true
...
function ENT:CreateMoneybag()
	...
	local Y = GAMEMODE.Config.diamondamount
	if amount == 0 then
		amount = 250
	end
	...
	self.sparking = false
	timer.Simple(math.random(360, 1800), function() PrintMore(self) end)
end
